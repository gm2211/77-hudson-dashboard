/**
 * Type definitions for Hudson Dashboard entities.
 *
 * AI AGENT NOTES:
 ...
 * ADMIN: Editable via AdvisoriesSection with label picker.
 */
export interface Advisory {
  /** Database primary key */
  id: number;
  /** Category label (e.g., "Weather Alert", "Building Notice") */
  label: string;
...
export interface BuildingConfig {
  ...
  id: number;
  /** Building number displayed in header (e.g., "77") */
  buildingNumber: string;
  /** Building name displayed in header (e.g., "Hudson") */
  buildingName: string;
  /** Subtitle below building name */
  subtitle: string;
  /**
