 ...
 * ```
 * {
 *   config: { buildingNumber, buildingName, subtitle },
...
interface SnapshotData {
  config?: { buildingNumber?: string; buildingName?: string; subtitle?: string } | null;
  services?: { items?: ServiceItem[]; scrollSpeed?: number };
